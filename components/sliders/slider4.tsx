...
import card12 from '../../public/coen-van-de-broek-On4QWhHJCEM-unsplash.jpg'
export const Slider4 = () => {
  return (
  //   <div>   
  //         <div className="p-8 min-h-screen flex items-center justify-center rounded-3xl bg-orange-950 ">
  ...
  <div className="bg-white shadow-md rounded-lg overflow-hidden">
      <Image src={card12} alt="Placeholder" className="w-full h-48 object-cover" />
      <div className="p-6">
