...
import card14 from '../../public/candra-winata-CYOFvtpOIpU-unsplash.jpg'
export const Slider1 = () => {
  return (
  //   <div>   
  //   <div className="p-10 min-h-screen flex items-center justify-center rounded-3xl  bg-gray-800 ">
  ...
  <div className="bg-white shadow-md rounded-lg overflow-hidden">
      <Image src={card14} alt="Placeholder" className="w-full h-48 object-cover" />
      <div className="p-6">
